...
int main()
{  
    //const MonsterCard dragon("Blue-Eyes White Dragon", "This legendary dragon is a powerful engine ofdestruction.",3, 3000, 2500);
    //std::ofstream f;
    //f << dragon;
   /* MonsterCard magician("Dark Magician", "The ultimate wizard.", 2500, 2100);
    ...
    PendulumCard timegazer("Timegazer Magician", "Your opponent cannot activate Trap MagicCards", 1200, 600, 8, CardType::SPELL);
